...
public class routes {
  ...
  public static final controllers.security.ReverseHomeCtrl HomeCtrl = new controllers.security.ReverseHomeCtrl(RoutesPrefix.byNamePrefix());
  ...
  public static class javascript {
    ...
    public static final controllers.security.javascript.ReverseHomeCtrl HomeCtrl = new controllers.security.javascript.ReverseHomeCtrl(RoutesPrefix.byNamePrefix());
