    ...
    <nav class="navbar navbar-default">
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav">
                ...
                <li>
                    """),_display_(/*48.22*/if(user !=null)/*48.37*/ {_display_(Seq[Any](format.raw/*48.39*/("""
                    """),format.raw/*49.21*/("""<a href=""""),_display_(/*49.31*/routes/*49.37*/.ShoppingCtrl.viewOrders),format.raw/*49.61*/("""">View Orders</a>
                    """)))}),format.raw/*50.22*/("""
                """),format.raw/*51.17*/("""</li>
            </ul>
