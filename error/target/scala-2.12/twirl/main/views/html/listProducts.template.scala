...
<div class="row">
  ...
  <div class="col-sm-10">
    ...
    <p>
        """),_display_(/*73.10*/if((user !=null) && ("admin".equals(user.getRole())))/*73.63*/ {_display_(Seq[Any](format.raw/*73.65*/("""
        """),format.raw/*74.9*/("""<a href=""""),_display_(/*74.19*/routes/*74.25*/.AdminProductCtrl.addProduct()),format.raw/*74.55*/("""">
