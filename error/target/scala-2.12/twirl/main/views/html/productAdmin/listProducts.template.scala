...
<div class="row">
  ...
  <div class="col-sm-9">
    ...
    <p>
        """),_display_(/*74.10*/if((user !=null) && ("admin".equals(user.getRole())))/*74.63*/ {_display_(Seq[Any](format.raw/*74.65*/("""
      """),format.raw/*75.7*/("""<a href=""""),_display_(/*75.17*/routes/*75.23*/.AdminProductCtrl.addProduct()),format.raw/*75.53*/("""">
